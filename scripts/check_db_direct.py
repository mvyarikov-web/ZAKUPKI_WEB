...
def main():
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            if has_vector:
                print(f"✅ Расширение pgvector уже установлено")
            else:
                print(f"⚠️  Расширение pgvector НЕ установлено (будет создано при миграции)")
            ...
            if tables:
                ...
                print(f"✅ База данных пустая (готова к миграции)")
