...
class ConfigService:
    ...
    def db_size_limit_bytes(self) -> int:
        ...
        По умолчанию: 10 ГБ
        """
        return int(os.getenv('DB_SIZE_LIMIT_BYTES', '10737418240'))  # 10 GB
    ...
    # ------------------------------------------------------------------------------
    # Примечание: Legacy файловый индекс (_search_index.txt) больше не поддерживается.
    # Индексация всегда происходит в PostgreSQL.
